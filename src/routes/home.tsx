...
import { Camera, ChevronRight, Clock, MapPin, RefreshCw } from "lucide-react";
...
function HomeScreen() {
  const { name, totalSaved, receipts } = useApp();
    ...
    <MobileShell>
      ...
      >
        ...
        <section className="px-5 pt-10">
          ...
          <div className="surface-card mt-4 grid grid-cols-3 gap-2 rounded-3xl p-5 text-center">
